...
$sb_service_path = "C:\SB Service\"
$sb_service = "SmartBambooApiService"
$sb_api = "sb_api_service.py"

$sf_systems =  "C:\SF Systems\"
...
nssm install $sb_service "py" "$sb_service_path\sb_api_service.py"
